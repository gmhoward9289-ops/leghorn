...
#   curl -sL https://github.com/gmhoward9289-ops/leghorn/releases/download/v0.4/leghorn-0.4.tar.gz | shasum -a 256
class Leghorn < Formula
  ...
  url "https://github.com/gmhoward9289-ops/leghorn/releases/download/v0.4/leghorn-0.4.tar.gz"
